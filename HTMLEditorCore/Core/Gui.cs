...
namespace HTMLEditorCore.Core
{
    ...
    {
        public static EditorWebBrowser webBrowser;
        ...
        {
            AddImageOrLinkWindow wnd = new AddImageOrLinkWindow(webBrowser.doc, false);
            wnd.ShowDialog();
        }

        public static void SettingsAddImage()
        {
            AddImageOrLinkWindow wnd = new AddImageOrLinkWindow(webBrowser.doc);
            wnd.ShowDialog();
        }
